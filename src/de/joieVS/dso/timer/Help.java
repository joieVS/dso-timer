...
public class Help extends CommandProcessor {
	...
	public static void executeCmd(@SuppressWarnings("unused") final String params) {
		out.println("Befehle: \n" //
				...
				+ "\t\tm 380x6m17 eisen s8\n\n" //
				+ "\tFür ein Quest sollen 40 Armbrüste produziert werden, es fehlen noch 38, der 12h-Produktionswert ist 66. Als Notiz will ich erinnert werden, dass es um das Gildenquest geht.\n" //
